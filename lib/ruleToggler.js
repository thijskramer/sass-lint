 ...
 * was encountered
 *
 * @param {Object} toggledRules - Contains the information about each rule disable comment
                                  encountered and which line/column it occurred on
...
/**
 * Adds each rule in our array of rules from an enable comment into the toggledRules object
...
/**
 * Adds each rule in our array of rules from a disable block comment into the toggledRules object
 * under the correct rule name along with the line and column number where the disable block comment
 * was encountered
 *
 * @param {Object} toggledRules - Contains the information about each rule enable
                                  encountered and which line/column that block occurred on
 * @param {Array} rules - An array of rule names
 ...
 *
 * @param {Object} toggledRules - Contains the information about the line disable comment encountered, the rule(s)
 ...
 * @returns {Boolean} Whether the current line/column of A is before or the same as B
 */
